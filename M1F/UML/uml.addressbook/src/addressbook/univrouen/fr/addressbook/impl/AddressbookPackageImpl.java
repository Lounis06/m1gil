...
public class AddressbookPackageImpl extends EPackageImpl implements AddressbookPackage {
	 ...
	 * @generated
	 */
	public EOperation getAdresse__Display() {
		return adresseEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EReference getAddressBook_Personne() {
	 ...
	 * @generated
	 */
	public EOperation getAddressBook__AddContact__Personne() {
	 ...
	 * @generated
	 */
	public EOperation getAddressBook__RemoveContact__Personne() {
		return addressBookEClass.getEOperations().get(1);
	}
	...
	public void createPackageContents() {
		...
		createEOperation(adresseEClass, ADRESSE___DISPLAY);
		...
		createEReference(addressBookEClass, ADDRESS_BOOK__PERSONNE);
		createEOperation(addressBookEClass, ADDRESS_BOOK___ADD_CONTACT__PERSONNE);
		createEOperation(addressBookEClass, ADDRESS_BOOK___REMOVE_CONTACT__PERSONNE);
	}
	...
	public void initializePackageContents() {
		...
		initEOperation(getAdresse__Display(), ecorePackage.getEString(), "display", 0, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEReference(getAddressBook_Personne(), this.getPersonne(), null, "personne", null, 0, -1, AddressBook.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getAddressBook__AddContact__Personne(), ecorePackage.getEBoolean(), "addContact", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getPersonne(), "p", 0, 1, IS_UNIQUE, IS_ORDERED);

		op = initEOperation(getAddressBook__RemoveContact__Personne(), ecorePackage.getEBoolean(), "removeContact", 0, 1, IS_UNIQUE, IS_ORDERED);
		addEParameter(op, this.getPersonne(), "p", 0, 1, IS_UNIQUE, IS_ORDERED);
