...
public class PersonneImpl extends MinimalEObjectImpl.Container implements Personne {
	...
	public String getIdentifier() {
		StringBuilder build = new StringBuilder(); {
			build.append(getNom().substring(0, 3));
			build.append(getPrenom().substring(0, 3));
			build.append(String.format("%03d", getAge()));
		}
	...
	public String display() {
		StringBuilder build = new StringBuilder(); {
			build.append("Nom : " + getNom() + "\n");
			build.append("Prenom : " + getPrenom() + "\n");
			build.append("Age : " + getAge() + "\n");
		}
